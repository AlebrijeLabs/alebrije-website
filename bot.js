...
async function deployCommands() {
    const commands = [
        // Basic Commands
        { name: 'help', description: 'Show all available ALBJ bot commands' },
        { name: 'info', description: 'Get detailed ALBJ token information' },
        { name: 'countdown', description: 'View the countdown to ALBJ token launch (June 12, 2025)' },
        
        // Alebrije Spirits Commands
        { name: 'spirits', description: 'View all 12 Alebrije spirits in the collection' },
        {
            name: 'alebrije',
        ...
        { name: 'price', description: 'Check ALBJ token price and market data (post-launch)' },
        { name: 'holders', description: 'Check current ALBJ token holder statistics' },
        { name: 'tokenomics', description: 'View detailed ALBJ token distribution and mechanics' },
        
        // Community Commands
        { name: 'roadmap', description: 'View the ALBJ token development roadmap' },
        { name: 'community', description: 'Get links to all ALBJ community platforms and social media' },
        { name: 'social', description: 'Get links to all ALBJ social media accounts' },
        { name: 'team', description: 'Meet the ALBJ development and advisory team' },
        { name: 'partnerships', description: 'View current and upcoming ALBJ partnerships' },
        
        // NFT & Gaming Commands
        { name: 'nft', description: 'Learn about the ALBJ Alebrije NFT collection' },
        { name: 'staking', description: 'Learn about ALBJ staking rewards and mechanisms' },
        { name: 'events', description: 'View upcoming ALBJ community events and activities' },
        
        // Fun Commands
        { name: 'quiz', description: 'Take an ALBJ knowledge quiz and test your understanding' },
        { name: 'joke', description: 'Get a random Alebrije-themed joke' },
        { name: 'quote', description: 'Get an inspirational quote from the Alebrije spirits' },
        { name: 'meme', description: 'Get a random ALBJ community meme' },
        { name: 'funfact', description: 'Learn a random fun fact about ALBJ or Alebrije spirits' },
        { name: 'daily', description: 'Get today\'s daily update and featured spirit' },
        ...
        },
        {
            ...
            options: [
                ...
                { name: 'channel', description: 'Channel to send announcement to', type: 7, required: false }
            ]
        }
    ];
...
async function handleQuizCommand(interaction) {
    const embed = new EmbedBuilder()
        ...
        .setDescription('**🎭 When is ALBJ Token launching?**\n\n1. May 15, 2025\n2. June 12, 2025\n3. July 4, 2025\n4. August 1, 2025')
        .setFooter({ text: 'Think you know the answer? The correct answer is #2!' })
        .setTimestamp();
