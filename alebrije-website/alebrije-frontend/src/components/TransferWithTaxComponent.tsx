...
const TAX_WALLET = new PublicKey('2ris4b77d1K2fjRgG1GGsJMJkrKCjNZA3dmgLuhsXBLQ'); // Tax wallet address (using mint authority as an example)

// Update the RPC endpoints to use devnet
const rpcEndpoints = [
