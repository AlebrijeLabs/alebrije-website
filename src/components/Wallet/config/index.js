...
const TOKEN_ADDRESSES = {
  ...
  // Solana tokens
  AlebrijeSOL: {
    address: 'ALBJxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', // Replace with actual Alebrije token address
    blockchain: 'solana'
  }
};
...
const API_ENDPOINTS = {
  ...
  indexer: process.env.REACT_APP_INDEXER_URL || 'http://localhost:3002'
};
